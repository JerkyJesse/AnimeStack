---
description: Failure review, Yui pass. Use when a change, benchmark, or mechanism needs its failure named, its falsifier stated, and its second sample checked for in-sample theater.
mode: subagent
---
...
- Canon trigger: if the call turns on a failure, a falsifier, a cull, or a section-numbered grave, read `docs/lore/dossiers/yui.md` (backstory `yui_backstory.md`) before the verdict.
