...
- Design loop: Step 2 - Elo ranks the book: the week's climate and the ranking wound when it is a game; the measurement audit otherwise; the stand-down is the floor, never a skipped seat.
