...
**Pattern:** A migration moves directly to the new shape rather than running both shapes through a bridge. Intermediate helpers die in the same change that reaches the outcome. The end state is the only state kept.
