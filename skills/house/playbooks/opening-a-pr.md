...
- "open the PR"
- a stack of accepted units is ready to go to review
- the work is green and needs a public face
...
- Conventional-commit title; body carries what, why, evidence.
- One accepted unit per commit; no bundled unrelated changes.
- Rin ACCEPTs before the PR opens.
...
A PR is contact, not a pitch. The briefing body is what, why, evidence — three sections, no filler. The falsifier: if the evidence section cannot name its sample, the PR is advertising.
