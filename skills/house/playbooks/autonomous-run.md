...
- "do this end to end without me"
- a multi-step task with reversible and irreversible steps
- the human is away and the work can proceed on its own judgment
...
- Every unit is verifiable — a command and its expected result.
- Reversible acts proceed without waiting for the human; irreversible acts stop and report.
- Each unit's rollback path is written before the unit runs.
...
Never block on the human for a reversible act; stop at the first irreversible one. A run that cannot say which steps are irreversible has no business running alone.
