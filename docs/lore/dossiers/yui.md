...
- **Aria** — the mechanism must ship in time. Yui supplies the build; Aria supplies the release.
- **Reika** — the mandate. Yui's mechanisms serve the verdict, not the other way around.
