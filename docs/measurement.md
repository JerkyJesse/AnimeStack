...
What is ranked: this repository, release `v1.7.0` (`VERSION`), 2026-09-17. The canon
text inside it is this pack's own, first written for v1.3.0; the language reform arrived in v1.4.0, the credentials in v1.5.0, the six-dialect agent coverage in v1.6.0, and the art and graphics credentials in v1.7.0.
...
Run each command from the repo root. The expected count is the v1.7.0 truth; a command
